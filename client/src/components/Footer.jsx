      ...
      <div className="w-full max-w-7xl mx-auto">
        <div className="grid w-full justify-between sm:flex md:grid-cols-1">
          <div className="mt-5">
            <Link
              to="/"
              className="self-center whitespace-nowrap font:semi-bold text-lg sm:text-xl dark:text-white "
            >
          ...
          <div className="grid grid-cols-2 gap-8 mt-4 sm:grid-cols-3 sm:gap-6 ">
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link
                  href="https://www.100jsprojects.ccom"
                  target="_blank"
            ...
            <div>
              ...
              <Footer.LinkGroup col>
                <Footer.Link
                  href="https://www.github.com/hamzaqadeer"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  Github
