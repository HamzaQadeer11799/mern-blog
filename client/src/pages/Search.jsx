...
export default function Search() {
  ...
  useEffect(() => {
    ...
    if (sortFromUrl || searchTermFromUrl || categoryFromUrl) {
      setSidebarData({
        ...sidebarData,
  ...
  return (
    <div className="flex flex-col md:flex-row">
      ...
      <div className="w-full">
        <h1 className="text-3xl p-3 font-semibold mt-5 md:border-b border-gray-500">
          Post Results:
        </h1>
        <div className="p-7 flex flex-wrap gap-3">
          ...
          {loading && <p className="text-xl text-gray-300">Loading...</p>}
          {!loading &&
            posts &&
